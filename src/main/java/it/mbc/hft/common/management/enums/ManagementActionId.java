...
public enum ManagementActionId {
    ...
    APPLY_SELECTION_FILTERS_MIN("APPLY_SELECTION_FILTERS_MIN"),
    APPLY_SELECTION_FILTERS_50("APPLY_SELECTION_FILTERS_50"),
    APPLY_SELECTION_FILTERS_100("APPLY_SELECTION_FILTERS_100"),
